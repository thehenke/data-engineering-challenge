CREATE DATABASE  IF NOT EXISTS `engineering` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `engineering`;
...
) ENGINE=InnoDB AUTO_INCREMENT=40235 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `salesorderdetail` (
  ...
  CONSTRAINT `fk_SalesOrderDetail_SpecialOfferProduct1` FOREIGN KEY (`SpecialOfferID`) REFERENCES `specialofferproduct` (`SpecialOfferID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `salesorderheader` (
  ...
  `AccountNumber` varchar(255) DEFAULT NULL,
  `SalesOrderHeadercol` varchar(45) DEFAULT NULL,
  `CustomerID` int NOT NULL,
  ...
  CONSTRAINT `fk_SalesOrderHeader_SalesOrderDetail1` FOREIGN KEY (`SalesOrderID`) REFERENCES `salesorderdetail` (`SalesOrderID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `specialofferproduct` (
  ...
  CONSTRAINT `fk_SpecialOfferProduct_Product1` FOREIGN KEY (`ProductID`) REFERENCES `product` (`ProductID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2021-05-20 21:23:04
